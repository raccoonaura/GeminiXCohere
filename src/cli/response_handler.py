    ...
    try:
        ...
        if cached:
            ...
            if file_handler.skip_gemini and not file_handler.skip_mistral_n_command:  # Mistral and Command working here
                if model_client.embed_model and model_client.rerank_model: print(f"Mistral thought for {model_client.mistral_end_thinking} seconds, took {model_client.mistral_end_generating} seconds to generate the answer, generated {len(model_client.mistral_response)} characters.\nCommand thought for {model_client.command_end_thinking} seconds, took {model_client.command_end_generating} seconds to generate the answer, generated {len(model_client.command_response)} characters.\nEmbedded using {model_client.embed_model}, reranked using {model_client.rerank_model}, generated response using model {model_client.mistral_model} and {model_client.command_model}.\n\n-------------------------\n\nGenerating full response...")
                elif model_client.embed_model: print(f"Mistral thought for {model_client.mistral_end_thinking} seconds, took {model_client.mistral_end_generating} seconds to generate the answer, generated {len(model_client.mistral_response)} characters.\nCommand thought for {model_client.command_end_thinking} seconds, took {model_client.command_end_generating} seconds to generate the answer, generated {len(model_client.command_response)} characters.\nEmbedded using {model_client.embed_model}, generated response using model {model_client.mistral_model} and {model_client.command_model}.\n\n-------------------------\n\nGenerating full response...")
                else: print(f"Mistral thought for {model_client.mistral_end_thinking} seconds, took {model_client.mistral_end_generating} seconds to generate the answer, generated {len(model_client.mistral_response)} characters.\nCommand thought for {model_client.command_end_thinking} seconds, took {model_client.command_end_generating} seconds to generate the answer, generated {len(model_client.command_response)} characters.\nUsing model {model_client.mistral_model} and {model_client.command_model}.\n\n-------------------------\n\nGenerating full response...")
