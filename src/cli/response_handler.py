...
def handle_conversation(question):
    ...
    try:
        ...
        # i know this part looks terrible but i swear ill improve it one day for now just dont fix it if it aint broke
        if not file_handler.skip_gemini and file_handler.skip_mistral_n_command:  # Gemini working here
            ...
            if model_client.embed_model and model_client.rerank_model and model_client.ocr_model:
                print(f"OCRed using {model_client.ocr_model}, embedded using {model_client.embed_model}, reranked using {model_client.rerank_model}, generated response using model {model_client.gemini_model}.")
            elif model_client.embed_model and model_client.ocr_model:
                print(f"OCRed using {model_client.ocr_model}, embedded using {model_client.embed_model}, generated response using model {model_client.gemini_model}.")
            elif model_client.ocr_model:
                print(f"OCRed using {model_client.ocr_model}, generated response using model {model_client.gemini_model}.")
            elif model_client.embed_model and model_client.rerank_model:
                print(f"Embedded using {model_client.embed_model}, reranked using {model_client.rerank_model}, generated response using model {model_client.gemini_model}.")
            elif model_client.embed_model:
                print(f"Embedded using {model_client.embed_model}, generated response using model {model_client.gemini_model}.")
            else:
                print(f"Generated response using model {model_client.gemini_model}.")
            print(f"\n-------------------------\n")
        ...
        if file_handler.skip_gemini and not file_handler.skip_mistral_n_command:  # Mistral and Command working here
            ...
            if model_client.embed_model and model_client.rerank_model and model_client.ocr_model:
                print(f"OCRed using {model_client.ocr_model}, embedded using {model_client.embed_model}, reranked using {model_client.rerank_model}, generated response using model {model_client.mistral_model} and {model_client.command_model}.")
            elif model_client.embed_model and model_client.ocr_model:
                print(f"OCRed using {model_client.ocr_model}, embedded using {model_client.embed_model}, generated response using model {model_client.mistral_model} and {model_client.command_model}.")
            elif model_client.ocr_model:
                print(f"OCRed using {model_client.ocr_model}, generated response using model {model_client.mistral_model} and {model_client.command_model}.")
            elif model_client.embed_model and model_client.rerank_model:
                print(f"Embedded using {model_client.embed_model}, reranked using {model_client.rerank_model}, generated response using model {model_client.mistral_model} and {model_client.command_model}.")
            elif model_client.embed_model:
                print(f"Embedded using {model_client.embed_model}, generated response using model {model_client.mistral_model} and {model_client.command_model}.")
            else:
                print(f"Generated response using model {model_client.mistral_model} and {model_client.command_model}.")
            ...
            if model_client.embed_model and model_client.rerank_model and model_client.ocr_model:
                print (f"OCRed using {model_client.ocr_model}, embedded using {model_client.embed_model}, reranked using {model_client.rerank_model}.\nGenerated response using model {model_client.mistral_model} and {model_client.command_model}, merged using {model_client.gemini_merge_model}.")
            elif model_client.embed_model and model_client.ocr_model:
                print (f"OCRed using {model_client.ocr_model}, embedded using {model_client.embed_model}.\nGenerated response using model {model_client.mistral_model} and {model_client.command_model}, merged using {model_client.gemini_merge_model}.")
            elif model_client.ocr_model:
                print (f"OCRed using {model_client.ocr_model}.\nGenerated response using model {model_client.mistral_model} and {model_client.command_model}, merged using {model_client.gemini_merge_model}.")
            elif model_client.embed_model and model_client.rerank_model:
                print (f"Embedded using {model_client.embed_model}, reranked using {model_client.rerank_model}.\nGenerated response using model {model_client.mistral_model} and {model_client.command_model}, merged using {model_client.gemini_merge_model}.")
            elif model_client.embed_model:
                print (f"Embedded using {model_client.embed_model}.\nGenerated response using model {model_client.mistral_model} and {model_client.command_model}, merged using {model_client.gemini_merge_model}.")
            else:
                print (f"Generated response using model {model_client.mistral_model} and {model_client.command_model}, merged using {model_client.gemini_merge_model}.")
            print(f"\n-------------------------\n")
        ...
        if not file_handler.skip_gemini and not file_handler.skip_mistral_n_command:  # handling regularly
            ...
            if model_client.embed_model and model_client.rerank_model and model_client.ocr_model:
                ...
                print (f"Generated response using model {model_client.gemini_model}, {model_client.mistral_model}, and {model_client.command_model}, merged using {model_client.gemini_merge_model}.")
            print(f"\n-------------------------\n")
