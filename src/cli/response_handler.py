    ...
    try:
        ...
        if not file_handler.skip_gemini and file_handler.skip_mistral_n_command:  # Gemini working here
            if model_client.embed_model and model_client.rerank_model and model_client.ocr_model:
                print(f"Gemini thought for {model_client.gemini_end_thinking} seconds, took {model_client.gemini_end_generating} seconds to generate the answer, generated {len(model_client.gemini_response)} characters.\nOCRed using {model_client.ocr_model}, embedded using {model_client.embed_model}, reranked using {model_client.rerank_model}, generated response using model {model_client.gemini_model}.\n\n-------------------------\n")
            elif model_client.embed_model and model_client.ocr_model:
                print(f"Gemini thought for {model_client.gemini_end_thinking} seconds, took {model_client.gemini_end_generating} seconds to generate the answer, generated {len(model_client.gemini_response)} characters.\nOCRed using {model_client.ocr_model}, embedded using {model_client.embed_model}, generated response using model {model_client.gemini_model}.\n\n-------------------------\n")
            elif model_client.ocr_model:
                print(f"Gemini thought for {model_client.gemini_end_thinking} seconds, took {model_client.gemini_end_generating} seconds to generate the answer, generated {len(model_client.gemini_response)} characters.\nOCRed using {model_client.ocr_model}, generated response using model {model_client.gemini_model}.\n\n-------------------------\n")
        ...
        if file_handler.skip_gemini and not file_handler.skip_mistral_n_command:  # Mistral and Command working here
            if model_client.embed_model and model_client.rerank_model and model_client.ocr_model:
                print(f"Mistral thought for {model_client.mistral_end_thinking} seconds, took {model_client.mistral_end_generating} seconds to generate the answer, generated {len(model_client.mistral_response)} characters.\nCommand thought for {model_client.command_end_thinking} seconds, took {model_client.command_end_generating} seconds to generate the answer, generated {len(model_client.command_response)} characters.\nOCRed using {model_client.ocr_model}, embedded using {model_client.embed_model}, reranked using {model_client.rerank_model}, generated response using model {model_client.mistral_model} and {model_client.command_model}.\n\n-------------------------\n\nGenerating full response...")
            elif model_client.embed_model and model_client.ocr_model:
                print(f"Mistral thought for {model_client.mistral_end_thinking} seconds, took {model_client.mistral_end_generating} seconds to generate the answer, generated {len(model_client.mistral_response)} characters.\nCommand thought for {model_client.command_end_thinking} seconds, took {model_client.command_end_generating} seconds to generate the answer, generated {len(model_client.command_response)} characters.\nOCRed using {model_client.ocr_model}, embedded using {model_client.embed_model}, generated response using model {model_client.mistral_model} and {model_client.command_model}.\n\n-------------------------\n\nGenerating full response...")
            elif model_client.ocr_model:
                print(f"Mistral thought for {model_client.mistral_end_thinking} seconds, took {model_client.mistral_end_generating} seconds to generate the answer, generated {len(model_client.mistral_response)} characters.\nCommand thought for {model_client.command_end_thinking} seconds, took {model_client.command_end_generating} seconds to generate the answer, generated {len(model_client.command_response)} characters.\nOCRed using {model_client.ocr_model}, generated response using model {model_client.mistral_model} and {model_client.command_model}.\n\n-------------------------\n\nGenerating full response...")
            elif model_client.embed_model and model_client.rerank_model:
